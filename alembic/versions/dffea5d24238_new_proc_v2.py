...
Revision ID: dffea5d24238
Revises: 93d9a935176e
Create Date: 2025-06-11 23:00:28.613271
...
revision: str = 'dffea5d24238'
down_revision: Union[str, None] = '93d9a935176e'
...
def upgrade() -> None:
    ...
    BEGIN
        ...
        WHERE s.subscription_id = v_sub_id;
